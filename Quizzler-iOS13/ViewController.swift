...
class ViewController: UIViewController {
    ...
    @IBAction func answerButtonPressed(_ sender: UIButton) {
        ...
        userAnswer == currentAnswer ? print("That's correct!") : print("Not quite.")
        updateButtonColor(sender: sender, isCorrect: userAnswer == currentAnswer)
    ...
    func updateProgressBar() {
        UIView.animate(withDuration: 0.25) {
            self.progressBar.progress = Float(self.currentQuestionIndex + 1) / Float(self.questions.count)
        }
    }
